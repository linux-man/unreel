      ...
      new SaxParser({
        ...
        start: function (name, attrs) {
          ...
          if (name === "iframe" || name === "object" || name === "embed" || name === "video" || name === "audio") {
            ...
            if(typeof(data["data-autoplay"]) === "string") data["data-autoplay"] = true;//cl
            else data["data-autoplay"] = false;
            if(data.class && data.class.includes("stretch")) data.stretch = true;//cl
            else data.stretch = false;
          }
    ...
    var createUi = function (onChange) {
      ...
      return {
        ...
        items: [
          ...
          {name: 'data-autoplay', type: 'checkbox', checked: false, text: 'Auto play'},//cl
          {name: 'stretch', type: 'checkbox', checked: false, text: 'Stretch'}//cl
        ]
      };
    };
...
define(
  ...
  function (Delay, HtmlToData, UpdateHtml, Service, Size, Tools, Env, SizeManager) {
    ...
    var submitForm = function (win, editor) {
      ...
      if (data.embed) {
        if(data["data-autoplay"] == true) {//cl
          data.embed = data.embed.replace("<video", "<video data-autoplay");
          data.embed = data.embed.replace("<iframe", "<iframe data-autoplay");
          data.embed = data.embed.replace("<audio", "<audio data-autoplay");
        }
        else {
          data.embed = data.embed.replace(" data-autoplay", "");
        }
        if(data.stretch == true) {
          data.embed = data.embed.replace("<video", "<video class=\"stretch\"");
          data.embed = data.embed.replace("<iframe", "<iframe class=\"stretch\"");
          data.embed = data.embed.replace("<audio", "<audio class=\"stretch\"");
        }
        else {
          data.embed = data.embed.replace(" class=\"stretch\"", "");
        }//cl
