    ...
    PluginManager.add('image', function (editor) {
      ...
      function showDialog(imageList) {
        ...
        function onSubmitForm() {
          ...
          if(!data["class"]) data["class"] = "";//cl
          if(data.stretch == true) {
            if(!data["class"].includes("stretch")) data["class"] = (data["class"] + " stretch").trim();
          }
          else data["class"] = data["class"].replace(/stretch/g, "").replace(/  /g, "").trim();//cl
        ...
        if (editor.settings.image_advtab) {
          ...
          if(data["class"]) data.stretch = data["class"].includes("stretch");//cl
